<?php
//Credits for author at bottom. Thank you to Garrett Murphy (http://gmurphey.com/2006/10/05/wordpress-plugin-page-link-manager/). This plugin was integrated into a single core tweak plugin for convenience.

// GLOBAL VARIABLES //
define('GDM_MARGIN', 20);
...
function gdm_page_links_management_form() {
	...
	<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
		<?php
		gdm_print_pages(0, 0, $excludedPages);
		?>
...
/*
*Page Link Manager Version: 0.3
*Garrett Murphey http://gmurphey.com/2006/10/05/wordpress-plugin-page-link-manager/
*/
?>