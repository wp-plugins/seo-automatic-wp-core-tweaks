...
if ($_REQUEST['action'] == "changecore") {
	...
	$options .= "<li><b>Uploads Folder: <font color=\"#ff0000\">You will need to have writable permission in the /wp-content folder for this to work. Otherwise, you will need to manually add the uploads folder so users can upload pictures into posts, etc.</font></b><br /><input name=\"uploads_folder\" type=\"checkbox\" value=\"ON\" /> Attempt to create the uploads folder and set the permission to writable.</li>";
} 
?>