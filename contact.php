...
'post_content' => $c_page_data);
	...
	<p>	Name <input type="text" name="contact_name" size="20" value="">
	<br />Company Name <input type="text" name="contact_co_name" size="20" value=""></p>
	...
	<p>Phone <input type="text" name="contact_phone" size="20" value="">
	<br />Fax <input type="text" name="contact_fax" size="20" value="">
