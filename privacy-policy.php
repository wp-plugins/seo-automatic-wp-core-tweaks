...
$post_id = wp_insert_post($info);
	...
	$options .= '<li><input name="privacy_policy" type="checkbox" value="ON" /> Create a privacy page with your contact information using text provided by FreePrivacyPolicy.com.<p>Company Name <input type="text" name="privacy_contact_name" size="20" value="Company Name"> &nbsp;&nbsp; Email <input type="text" name="privacy_contact_email" size="20" value="Email"><br /><small><b>We recommended that you edit and customize your own with their <a href="http://www.seoautomatic.com/trust-guard/" target="_blank"> privacy policy creator</a>.</b></small></p></li>';
} 
?>