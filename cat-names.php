...
if ($_REQUEST['action'] == "changecore") {
	...
	$options .= "<li><input type=\"checkbox\" name=\"d_blogroll\" value=\"ON\" checked> Change default blogroll category from blogroll to: <input type=\"text\" name=\"cat_2\" size=\"20\" value=\"Related\" /></li>";
}
?>